...
import { Check, X, Clock, Flame, Shield, UserCheck, Headset, TrendingUp, BarChart3, Award } from "lucide-react";

const HeroSection = () => {
  const navigate = useNavigate();
  const [selectedPackage, setSelectedPackage] = React.useState<'1000'|'5000'|'10000'>('5000');
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="slide-up stagger-1">
            ...
            <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold mb-6 leading-tight">
              Potencialize sua <span className="bg-clip-text text-transparent bg-gradient-to-r from-primary to-accent">presença digital</span> com engajamento real
            </h2>
            
            <p className="text-gray-600 text-lg mb-8 max-w-2xl">
              Alavanque suas redes sociais com seguidores autênticos e engajados. Construa credibilidade, amplie seu alcance e destaque-se na era digital.
            </p>
            ...
            <div className="flex flex-wrap gap-6 mb-10 slide-up stagger-2">
              <div className="bg-white/60 backdrop-blur-sm shadow-sm border border-slate-100 rounded-xl p-4 px-6 relative overflow-hidden group">
                ...
                <p className="text-sm text-gray-500 mb-1 relative z-10">Seguidores Entregues</p>
                <p className="text-2xl font-bold text-gray-800 relative z-10">+3.5 Milhões</p>
              </div>
              
              <div className="bg-white/60 backdrop-blur-sm shadow-sm border border-slate-100 rounded-xl p-4 px-6 relative overflow-hidden group">
                <div className="absolute inset-0 bg-gradient-to-r from-primary/5 to-accent/5 opacity-0 group-hover:opacity-100 transition-opacity duration-300"></div>
                <p className="text-sm text-gray-500 mb-1 relative z-10">Clientes Satisfeitos</p>
                <p className="text-2xl font-bold text-gray-800 relative z-10">+12 Mil</p>
              </div>
            </div>
          ...
          <div className="hidden lg:block relative slide-up stagger-5">
            <div className="w-full aspect-[4/3] relative z-10">
              ...
              <div className="absolute top-0 left-1/2 -translate-x-1/2 w-[80%] bg-white rounded-3xl shadow-xl border border-gray-200 overflow-hidden">
                  ...
                  <div className="flex items-center gap-3">
                    <div className="w-12 h-12 rounded-full bg-gradient-to-br from-primary to-accent flex items-center justify-center text-white font-bold">
                      <div className="flex-shrink-0 bg-blue-500/10 text-blue-500 px-3 py-1.5 rounded-full text-xs font-medium flex items-center gap-1.5">
                        ...
                        <div className="font-bold">impulsegram</div>
                      </div>
                    </div>
                      <div>
                      <div className="font-bold">impulsegram</div>
                      <div className="text-xs text-gray-500">2 min atrás</div>
                    </div>
                  </div>
                </div>
                ...
                <div className="grid grid-cols-3 text-center py-3 border-y border-gray-100">
                  ...
                  <div className="relative">
                    ...
                    <div className="absolute top-0 right-4 text-xs text-green-500 flex items-center">
                ...
                <div className="grid grid-cols-3 gap-1 p-1">
                  {[...Array(9)].map((_, i) => (
                    <div key={i} className="aspect-square bg-gradient-to-br from-gray-100 to-gray-200 rounded-sm overflow-hidden">
                      {i % 3 === 0 && (
              ...
              <div className="absolute top-1/4 -right-6 animate-float">
                <div className="relative bg-white shadow-lg rounded-lg p-2 flex items-center gap-2">
                  <div className="w-8 h-8 rounded-full bg-green-100 flex items-center justify-center text-green-600">
                    <Check className="w-4 h-4" />
                </div>
                  <div className="text-xs">
                    <p className="font-semibold">+1250 seguidores</p>
                    <p className="text-gray-400">Entregue com sucesso</p>
                </div>
                </div>
              </div>
              ...
              <div className="absolute bottom-1/4 -left-10 animate-float-slow">
                <div className="relative bg-white shadow-lg rounded-lg p-2 flex items-center gap-2">
                  ...
                  <div className="text-xs">
                    ...
                    <p className="text-gray-400">Métodos seguros</p>
                  </div>
                </div>
              </div>
            </div>
