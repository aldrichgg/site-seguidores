...
const Payment = () => {
  ...
  useEffect(() => {
    ...
    if (orderBumps.antiDrop) total += 7.9;
  ...
  const handleSubmitPayment = async () => {
    ...
    try {
      ...
      const result = await response.json();
         ...
         setQrCodeTimer(300); // Reset timer para 5 minutos
                  ...
                  <CardContent className="p-6">
                       ...
                       <div className="bg-gradient-to-r from-purple-50 to-pink-50 border border-purple-200 rounded-xl p-4">
                         <div className="flex justify-between items-center">
                           <div className="flex items-center gap-2">
                             ...
                             <div>
                               <h3 className="font-semibold text-gray-800">Bônus Especial</h3>
                               <p className="text-xs text-gray-600">Aproveite esta oferta exclusiva</p>
                             </div>
                           </div>
                           <div className="text-right">
                             ...
                             <p className="text-xs text-purple-600 font-medium">Valor Original: R$ 29,90</p>
                           </div>
                         </div>
                       </div>
                    ...
                    <Separator className="my-4" />
                       ...
                       <div className="flex justify-between">
                         ...
                         <span className="text-sm font-medium text-purple-600">GRÁTIS</span>
                       </div>
                       <div className="flex justify-between">
                         <span className="text-sm text-gray-500 flex items-center gap-1.5">
                           <DollarSign size={14} />
                     ...
                     <div className="mt-8 space-y-4">
                       <div className="border-t border-gray-100 pt-6">
                         ...
                         <p className="text-sm text-gray-600 mb-6">
                           Turbine ainda mais seus resultados com estas ofertas exclusivas
                         </p>
                       </div>

                       {/* Order Bump 1: Entrega Turbo */}
                       <div className={`relative border rounded-xl p-5 transition-all duration-200 ${
                         orderBumps.turboDelivery 
                         ...
                         <div className="flex items-start gap-4">
                           <div className="flex items-center justify-center w-6 h-6 mt-1">
                             <input
                               ...
                               onChange={() => handleOrderBumpChange('turboDelivery')}
                               className="h-5 w-5 rounded border-2 border-blue-400 text-blue-600 focus:ring-blue-500 focus:ring-2 focus:ring-offset-2"
                             />
                           </div>
                           <div className="flex-1">
                             <div className="flex items-center gap-2 mb-2">
                               <h4 className="font-bold text-gray-800 text-lg">Entrega Turbo + Garantia Blindada</h4>
                               <span className="text-xs bg-blue-100 text-blue-700 px-2 py-0.5 rounded-full font-medium">
                                 POPULAR
                               </span>
                             </div>
                             <p className="text-sm text-gray-600 leading-relaxed">
                               ⚡ <span className="font-semibold text-blue-600">Por apenas R$9,90</span>, ative a Entrega Turbo e receba seus seguidores até 5x mais rápido, com garantia de reposição automática caso algum caia. Segurança total para seu perfil!
                             </p>
                           </div>
                         </div>
                       </div>
                         ...
                         <div className="flex items-start gap-4">
                           <div className="flex items-center justify-center w-6 h-6 mt-1">
                             <input
                               ...
                               onChange={() => handleOrderBumpChange('boostEngagement')}
                               className="h-5 w-5 rounded border-2 border-blue-400 text-blue-600 focus:ring-blue-500 focus:ring-2 focus:ring-offset-2"
                             />
                           </div>
                           <div className="flex-1">
                             <div className="flex items-center gap-2 mb-2">
                               <h4 className="font-bold text-gray-800 text-lg">Boost Automático de Engajamento</h4>
                               <span className="text-xs bg-green-100 text-green-700 px-2 py-0.5 rounded-full font-medium">
                                 RECOMENDADO
                               </span>
                             </div>
                             <p className="text-sm text-gray-600 leading-relaxed">
                               🚀 <span className="font-semibold text-green-600">Adicione agora por apenas R$14,90</span>: curtidas automáticas nos seus próximos 3 posts para turbinar ainda mais seu alcance e engajamento.
                             </p>
                           </div>
                         </div>
                       </div>
                       ...
                       <div className={`relative border rounded-xl p-5 transition-all duration-200 ${
                         ...
                         <div className="flex items-start gap-4">
                           ...
                           <div className="flex-1">
                             <div className="flex items-center gap-2 mb-2">
                               <h4 className="font-bold text-gray-800 text-lg">Verificação Anti-Queda</h4>
                               <span className="text-xs bg-amber-100 text-amber-700 px-2 py-0.5 rounded-full font-medium">
                                 SEGURANÇA
                               </span>
                             </div>
                             <p className="text-sm text-gray-600 leading-relaxed">
                               🛡️ <span className="font-semibold text-amber-600">Por R$7,90</span>, ative a proteção anti-queda: se qualquer seguidor cair, repomos sem custo extra por 30 dias.
                             </p>
                           </div>
                         </div>
                       </div>
                    ...
                    {qrCode && (
                      <div className="mt-6 space-y-4">
                        <div className="bg-green-50 border border-green-200 rounded-xl p-6">
                             ...
                             <div className="flex-1">
                               <h3 className="font-semibold text-green-800">QR Code PIX Gerado</h3>
                               <p className="text-sm text-green-600">Escaneie com seu aplicativo bancário</p>
                             </div>
                   ...
                   <div className="flex items-start gap-4 p-6 border-2 border-blue-200 rounded-xl bg-gradient-to-r from-blue-50 to-indigo-50 shadow-lg">
                     ...
                     <div className="flex-1">
                       ...
                       <p className="text-sm text-gray-600 mt-2 leading-relaxed">
                         ...
                         . Esta confirmação é necessária para processar seu pagamento com segurança.
                       </p>
                       {!acceptTerms && (
                         <div className="flex items-center gap-2 mt-3 p-3 bg-amber-50 border border-amber-200 rounded-lg">
                           <AlertCircle className="h-4 w-4 text-amber-600 flex-shrink-0" />
                           <span className="text-sm text-amber-700 font-medium">
                             Você precisa aceitar os termos para continuar com o pagamento
                           </span>
                         </div>
                       )}
                     </div>
