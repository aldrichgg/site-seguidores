...
// Links de navegação - apenas dashboard para influenciadores
const navItems = [
  { 
        ...
        <header className="flex flex-col md:flex-row justify-between items-start md:items-center mb-4 md:mb-6 space-y-3 md:space-y-0">
          <div className="flex items-center justify-between w-full md:w-auto">
            <div className="flex items-center space-x-2">
              ...
              <h1 className="text-xl md:text-2xl font-bold">Painel Influencer</h1>
            </div>
            ...
            <Sheet>
              <SheetTrigger asChild>
                <Button 
                  variant="ghost" 
                  size="icon" 
                  className="md:hidden inline-flex items-center justify-center rounded-md p-2.5 text-purple-600 hover:bg-purple-50"
                >
              ...
              <SheetContent side="left" className="w-[280px] sm:w-[350px] p-0">
                <div className="py-6 px-5 bg-gradient-to-br from-purple-50 to-pink-50 border-b border-purple-100">
                  <div className="flex items-center justify-between mb-5">
                    <div className="flex items-center space-x-2">
                      ...
                      <h2 className="text-xl font-bold text-purple-800">Influencer</h2>
                    </div>
                    <SheetClose asChild>
                  ...
                  <div className="flex items-center gap-3 mb-4 mt-6 bg-white p-3 rounded-lg shadow-sm">
                    <Avatar className="h-10 w-10 border-2 border-purple-200">
                      <AvatarImage src="https://i.pravatar.cc/40?img=5" alt="Influencer" />
                      <AvatarFallback>IN</AvatarFallback>
                    </Avatar>
                    <div>
                      <p className="font-medium text-purple-800">{user?.name || 'Influencer'}</p>
                      <p className="text-xs text-purple-600">Criador de Conteúdo</p>
                    </div>
                  </div>
                </div>
                    ...
                    {navItems.map((item) => (
                      <li key={item.path} className="transform hover:translate-x-1 transition-transform">
                        <SheetClose asChild>
                          ...
                          >
                            <item.icon size={20} className={currentPath === item.path ? "text-purple-600" : "text-gray-500"} />
          ...
          <div className="flex items-center space-x-4 w-full md:w-auto">
            <div className="relative flex-1 md:flex-none">
              ...
              <input
                ...
                className="w-full pl-10 pr-4 py-2.5 rounded-lg border border-gray-300 bg-white focus:outline-none focus:ring-2 focus:ring-purple-500 shadow-sm hover:shadow-md transition-shadow"
              />
            </div>
            ...
            <details className="relative hidden md:block">
              <summary className="list-none cursor-pointer flex items-center space-x-2">
                <img
                  ...
                  alt="Influencer"
                  className="w-10 h-10 rounded-full object-cover border-2 border-purple-500 hover:border-purple-400 transition-colors shadow-md hover:shadow-lg transform hover:scale-105 transition-transform"
                />
                <span className="hidden md:inline font-medium">{user?.name || 'Influencer'}</span>
              </summary>
              ...
              <ul className="space-y-3">
                {navItems.map((item) => (
                  ...
                  >
                    ...
                    >
                      <item.icon size={20} className={currentPath === item.path ? "text-purple-600" : ""} />
                      <span
                        className={
